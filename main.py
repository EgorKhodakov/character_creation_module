...
def attack(char_name, char_class):
    ...
    if char_class == 'healer':
        return (f'{char_name} нанёс урон противнику равный '
                f'{5 + randint(-3, -1)}')
    return (f'{char_name} урон не нанесен')
...
def defence(char_name, char_class):
    ...
    return (f'{char_name} блокировка не сработала')
...
def choice_char_class():
    ...
    while approve_choice != 'y':
        char_class = input(
            'Введи название класса, за которого хочешь играть:'
            'Воитель — warrior'
            'Маг — mage'
            'Лекарь — healer:')
        if char_class == 'warrior':
        ...
        approve_choice = input(
            ...
            'или другую кнопку, чтобы выбрать другой класс ').lower()
    return char_class
